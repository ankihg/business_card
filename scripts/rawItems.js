...
var rawData = [
  {
    ...
    about: '<p>Like an interstate, the Willamette River tears the metropolis. Cross me to connect. Explore bridges and other crossings in the U.S. state of Oregon.</p><p>Check it out.</p>'
  },
  {
    name: 'ZANREADS . INFO',
    ...
    about: '<p>My friend and client Zan requested a spooky website to display book reviews.</p> <br>&nbsp; &nbsp; &nbsp; &nbsp; Midnight moon illuminates literary alarm <br>&nbsp; &nbsp; &nbsp; &nbsp; Fiction is found in the forest <br> &nbsp; &nbsp; &nbsp; &nbsp; Ghosts grab ominous novels <br>&nbsp; &nbsp; &nbsp; &nbsp; Eerie reads for a cyberchill to the bone'
  },
  {
    name: 'SEATTLE SKYLINE',
    url: 'http://ankihg.ucoz.com/index/seattle_skyline/0-78',
    imgSrc: 'http://ankihg.ucoz.com/seattle_skyline/screenshots/seattle_skyline1.png',
    date:'2015-10-05',
    tags: ['HTML', 'CSS', 'JavaScript', 'Google Maps API'],
    about: '<p>An interactive map to explore the skyline of Seattle, this served as my platform to gain proficiency with Google Maps Javascript API. It is written in JavaScript and uses several Google Maps features including custom markers, events, and animations. Familiarize yourself or assess your intimacy with the edifices.</p>'
  },
  {
    name: 'WILLAMETTECOLLEGIAN . COM',
    url: 'http://willamettecollegian.com/',
    imgSrc: 'http://ankihg.ucoz.com/wu_col/img1.png',
    date:'2015-3-15',
    tags: ['HTML', 'CSS', 'WordPress'],
    about: "<p>I served as webmaster for my university's newspaper. This was my first expoersure to web development. Many of my redesigns remain active.</p>"
  },
  {
    name: '19-TET Isomorphic Keyboard',
  ...
  {
    name: 'Great Grammar Transformer',
